    ...
    public class ProductManager : IProductService
    {
        ...
        public IDataResult<List<Product>> GetAllByCategoryId(int id)
        {
            return new SuccessDataResult<List<Product>>(_productDal.GetAll
                (p => p.CategoryId == id),"Ürünler listelendi");
        }

        public IDataResult<Product> GetById(int productId)
        {
            return new SuccessDataResult<Product>(_productDal.Get
                (p => p.ProductId == productId),"Ürün listelendi");
        }
        ...
        public IDataResult<List<Product>> GetByUnitPrice(decimal min, decimal max)
        {
            return new SuccessDataResult<List<Product>>(_productDal.GetAll
                (p => p.UnitPrice > min 
                && p.UnitPrice < max),"Ürün listelendi");
        }
        ...
        public IDataResult<List<ProductDetailDto>> GetProductDetails()
        {
            ...
            return new SuccessDataResult<List<ProductDetailDto>>
                (_productDal.GetProductDetails(),"Ürün detayları listelendi");
        }
    }
}
